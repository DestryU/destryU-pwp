...
- ssh into the server
    - For Mac and Linux: `ssh root@destryu.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo destryu`
    - replace destryu with your own
- create password
    - `passwd destryu`
- Move .ssh key file
    - `cp -r .ssh /home/destryu`
- change ownership of the .ssh directory
    - `cd /home/destryu`
    - `chown -R destryu:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh destryu@destryu.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/destryu.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/destryu.com/html`
...
- `sudo vim /etc/nginx/sites-available/destryu.com`
...
server {
    ...
    root /var/www/destryu.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name destryu.com www.destryu.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/destryu.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/destryu/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/destryu/.ssh/github_deploy_key.pub >> /home/destryu/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/destryu/.ssh/github_deploy_key`
